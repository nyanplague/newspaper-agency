...
from agency.views import (index, NewspaperListView, NewspaperCreateView,
                          TopicDetailView, TopicCreateView, TopicDeleteView, RedactorListView,
                          RedactorCreateView, RedactorUpdateView, RedactorDeleteView, newspaper_detail_view,
                          NewspaperDeleteView, NewspaperUpdateView, redactor_detail_view)

urlpatterns = [
    path("", index, name="index"),
    path("newspapers/", NewspaperListView.as_view(), name="newspaper-list"),
    path("newspapers/<int:pk>/", newspaper_detail_view, name="newspaper-detail"),
